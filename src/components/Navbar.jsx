...
const Navbar = ({ searchText, setSearchText, filterPriority, setFilterPriority }) => {
  return (
    <div className="w-full bg-purple-800">
      <nav className='flex flex-col sm:flex-row max-w-[2000px] mx-auto text-white py-5 px-4'>
        ...
        <div className='flex flex-col sm:flex-row items-center justify-end gap-4 mt-4 sm:mt-0 sm:w-2/3'>
          <input
            type="text"
          ...
          <select
            ...
            className="px-4 py-1 rounded-lg bg-purple-700 text-white border border-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-400 w-full sm:w-auto"
          >
